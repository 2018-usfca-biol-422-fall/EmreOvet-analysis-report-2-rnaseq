...
joined_table %>%
  ...
  geom_jitter(colour = "red", size = 1)
ggtitle("EGFR gene expression in smoker vs non-smoker individuals with stage 3A cancer")
```
...
joined_table %>%
  ...
  ggplot(aes(x = smoking_status, y = counts_lengthscaledtpm)) +
  geom_jitter(colour = "red", size = 1)
ggtitle("EGFR gene expression in smoker vs non-smoker individuals with stage 3B cancer")
```
...
joined_table %>%
  ...
  ggplot(aes(x = smoking_status, y = counts_lengthscaledtpm)) +
  geom_jitter(colour = "red", size = 1)
ggtitle("EGFR gene expression in smoker vs non-smoker individuals with stage 4 cancer")
```
